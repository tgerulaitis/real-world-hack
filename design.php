	...
	<div class="row">
  	<div class="large-12 columns">
  	  <div class="block">
  	    ...
  	    <a href="" class="try right">Try another</a>
  	    ...
  	    <h4 class="subheader">Your answer</h4>
              <div class="row collapse">
                ...
                <div class="small-2 columns">
                  <a href="#" class="button prefix">Guess</a>
                </div>
              </div>
            </div> 
  	    </div>
  	   ...
  	   <hr />
  	       <ul class="icons small-block-grid-1 large-block-grid-2">
    	       <li id="actor">
	    	       ...
	    	       <a href="" class="try">Reveal hint</a>
	    	       <span class="hidden"  John Smith</span>
    	       </li>
    	       <li id="director">
    	       ...
    	       <li id="year">
	    	       <strong>Year:</strong>
	    	       <a href="" class="try">Reveal hint</a>
	    	       <span class="hidden" 2009</span>
    	       </li>
    	       <li id="genre">
	    	       <strong>Genre:</strong>
	    	       <a href="" class="try">Reveal hint</a>
	    	       <span class="hidden"  Horror</span>
    	       </li>
  	       </ul>
  	  </div>
  	</div>
